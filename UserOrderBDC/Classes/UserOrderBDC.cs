...
namespace UserOrderBDC.Classes
{
    ...
    {
        public static string userServicePath = Environment.GetEnvironmentVariable("USERSERVICE_PATH") != null ? Environment.GetEnvironmentVariable("USERSERVICE_PATH") : "http://franklin_curie:80";

        public static string orderServicePath = Environment.GetEnvironmentVariable("ORDERSERVICE_PATH") != null ? Environment.GetEnvironmentVariable("ORDERSERVICE_PATH") : "http://epic_easley:80";
